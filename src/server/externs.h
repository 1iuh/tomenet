...
extern int Send_store(int ind, u16b pos, byte attr, int wgt, int number, int price, cptr name, byte tval, byte sval, s16b pval, char *powers);
extern int Send_store_wide(int ind, u16b pos, byte attr, int wgt, int number, int price, cptr name, byte tval, byte sval, s16b pval,
...
extern void casino_result(int Ind, bool win, bool deduct_loss);
